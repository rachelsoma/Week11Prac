...
public class Movie_18820821 {
  ...
  static Movie_18820821[] arrayMovies = null;
   ...
   */
  public Movie_18820821(int movieID, String movieTitle, String director, String writer, double duration,
  ...
  public static Movie_18820821[] readFile(File inFile, String fileName) throws IOException {
    ...
    Movie_18820821[] arrayMovies = new Movie_18820821[50];
    ...
    while (inputFile.hasNextLine() && countMovies < arrayMovies.length) {
      ...
      // create movie object
      arrayMovies[countMovies] = new Movie_18820821(inID, inTitle, inDirector, inWriter, inDuration, inGenre,
  ...
  public static void print(Movie_18820821[] arrayMovies) {
  ...
  public static void sortName(Movie_18820821[] arr) {
    int startAt; // index of starting position
    int j; // loop control
    int minIndex; // index of smallest element
    Movie_18820821 tempObj; // temp object for swapping
  ...
  public static void sortGenre(Movie_18820821[] arr) {
    int minIndex; // index of smallest element
    Movie_18820821 tempObj; // temp object for swapping
  ...
  public static int search(Movie_18820821[] array, String lookingFor) {
    int i = 0;
    int foundAt = -1;
    boolean found = false;
  ...
  public static void changeGenre() {
    ...
    int foundAt = Movie_18820821.search(arrayMovies, lookingFor);
    System.out
...
System.out.println("Enter your rating: ");
  ...
  static void save() throws IOException {
    PrintWriter outMovieFile = new PrintWriter("movieLibrary.txt");
   
    for (int i = 0; i < arrayMovies.length && arrayMovies[i] != null; i++) {
      outMovieFile.printf("%s, %s, %s, %s, %s \n", arrayMovies[i].getMovieTitle(),
          arrayMovies[i].getDuration(), arrayMovies[i].getGenre(),
          arrayMovies[i].getClassification(), arrayMovies[i].getRating());
    }
    //close files
